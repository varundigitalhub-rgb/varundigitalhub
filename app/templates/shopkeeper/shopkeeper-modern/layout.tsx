...
const TEMPLATE_NAME = "Modern Local Store Website";
const BASE_PATH = "/templates/shopkeeper/shopkeeper-modern";
...
export default function ShopkeeperModernLayout({
  children,
}: {
  children: ReactNode;
}) {
      ...
      <footer className="border-t border-slate-200 bg-slate-900 text-white">
        <div className="container mx-auto flex flex-col gap-3 px-6 py-4 md:flex-row md:items-center md:justify-between">
          <p className="text-xs md:text-sm text-slate-100">
            Like this Modern Local Store website? Use it to show products,
            timings, and contact details for your own shop.
          </p>
