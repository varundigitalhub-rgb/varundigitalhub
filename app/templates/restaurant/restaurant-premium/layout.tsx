...
const TEMPLATE_NAME = "Premium Dining Restaurant";
...
export default function RestaurantPremiumLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-white">
      ...
      <footer className="border-t border-slate-800 bg-black text-amber-50">
        <div className="container mx-auto flex flex-col gap-3 px-6 py-4 md:flex-row md:items-center md:justify-between">
          <p className="text-xs md:text-sm text-amber-100">
            Like this Premium Restaurant website? Get it customised for your
            fine-dining or luxury dining brand.
          </p>
