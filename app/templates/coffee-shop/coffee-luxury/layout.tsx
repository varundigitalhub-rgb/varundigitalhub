...
const TEMPLATE_NAME = "Luxury Coffee Lounge";
const BASE_PATH = "/templates/coffee-shop/coffee-luxury";
...
export default function CoffeeLuxuryLayout({
  children,
}: {
  children: ReactNode;
}) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950 text-white">
      ...
      <footer className="border-t border-zinc-800 bg-black text-amber-50">
        <div className="container mx-auto flex flex-col gap-3 px-6 py-4 md:flex-row md:items-center md:justify-between">
          <p className="text-xs md:text-sm text-amber-100">
            Like this Luxury Coffee website? Get it customised for your lounge
            or premium cafe brand.
          </p>
          <div className="flex flex-col gap-2 sm:flex-row">
            <Link
              href="/contact"
              className="inline-flex justify-center rounded-full bg-amber-500 px-5 py-2 text-xs md:text-sm font-semibold text-black shadow-sm hover:bg-amber-400"
            >
              Get This Website
            </Link>
            <a
              ...
              className="inline-flex justify-center rounded-full border border-amber-300 px-5 py-2 text-xs md:text-sm font-semibold text-amber-100 hover:bg-white/5"
            >
              Chat on WhatsApp
            </a>
          </div>
