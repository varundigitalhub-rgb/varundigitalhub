...
const TEMPLATE_NAME = "Startup Landing Page";
const BASE_PATH = "/templates/landing-page/landing-product";
...
export default function LandingProductLayout({
  children,
}: {
  children: ReactNode;
}) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-white">
      ...
      <footer className="border-t border-purple-700 bg-purple-800">
        <div className="container mx-auto flex flex-col gap-3 px-6 py-4 md:flex-row md:items-center md:justify-between">
          <p className="text-xs md:text-sm text-purple-50">
            Like this Landing Page design? Use it for your product, service, or
            campaign with full branding customisation.
          </p>
          <div className="flex flex-col gap-2 sm:flex-row">
            <Link
              href="/contact"
              className="inline-flex justify-center rounded-full bg-white px-5 py-2 text-xs md:text-sm font-semibold text-purple-900 shadow-sm hover:bg-purple-50"
            >
              Get This Website
            </Link>
            <a
              ...
              className="inline-flex justify-center rounded-full border border-purple-100 px-5 py-2 text-xs md:text-sm font-semibold text-white hover:bg-purple-700"
            >
              Chat on WhatsApp
            </a>
          </div>
