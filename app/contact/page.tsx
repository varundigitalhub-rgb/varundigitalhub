...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mojnqepj", {
        method: "POST",
        headers: {
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button
                ...
                className="bg-purple-700 disabled:bg-purple-400 disabled:cursor-not-allowed text-white rounded-full px-8 py-4 font-semibold shadow-lg hover:bg-purple-800 hover:shadow-xl transition-all flex items-center justify-center gap-2 flex-1"
              >
            ...
            {status === "success" && (
              <div className="text-sm mt-4 text-center text-green-600">
